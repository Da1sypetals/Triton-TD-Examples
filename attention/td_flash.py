...
def flash_attn_bwd_calc_delta(
    ...
    return torch.sum(o * do, dim=-1, dtype=torch.float32)
...
class TritonFlashAttention(torch.autograd.Function):
    ...
    def forward(
        ...
        batch_size_k, num_k_heads, num_k_tokens, head_dim_k = k.shape
        batch_size_v, num_v_heads, num_v_tokens, head_dim_v = v.shape
...
if __name__ == "__main__":
    ...
    main(batch_size=2, seq_len=4101, num_heads=8, dim=64, dtype=torch.float32)
